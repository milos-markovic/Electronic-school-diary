...
<div class="card">
    ...
    <table class='table parent_table'>
        ...
        <tbody>
            <tr>
                <td><img src="{{ asset('images/'.$parent->photo->name) }}" width='100' class="border" /></td>
...
<h6 class="mt-4">Add student to parent {{ $parent->first_name.' '.$parent->last_name }}</h6><br>

@endif

 <a href="{{ route('parents.createStudent',$parent->id) }}" class="btn btn-outline-primary" >Add Student</a>
